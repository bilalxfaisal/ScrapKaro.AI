...
export const ResearchForm: React.FC = () => {
  ...
  const onSubmit = (data: ResearchFormData) => {
    // 9. On clicking Generate Research, DO NOT call any API. Print to browser console instead.
    console.log("=== Research Form Submission ===")
    console.log(JSON.stringify(data, null, 2))
    console.log("================================")

    alert("Research parameters collected! Check the browser console to view the payload.")
    navigate("/results")
  }
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <CardFooter className="border-t border-zinc-900/60 pt-6 pb-8 px-6 sm:px-8 flex justify-between gap-4">
            ...
            {currentStep < 4 ? (
              ...
              <Button
                type="submit"
                className="bg-gradient-to-r from-violet-600 to-indigo-650 hover:from-violet-700 hover:to-indigo-700 text-white border-none shadow-[0_0_20px_rgba(139,92,246,0.3)] shadow-violet-500/20 active:scale-95 transition-all duration-200"
              >
                Generate Research
